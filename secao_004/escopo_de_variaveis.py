...
Existem dois casos de escopo:

1 - Variáveis globais;
    - Variáveis globais são reconhecinhas, ou seja, seu escopo compreende, todo o programa.
...
ao declararmos ema variável, nós não colocamos o tipo de dado dela.
...
numero = 'Geek' # Em Python é possível a reatribuição
print(numero)
print(type(numero))
